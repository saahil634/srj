...
export function ManifestPreview({ manifest }: ManifestPreviewProps) {
  return (
    <section className="rounded-[2rem] border border-slate-200 bg-ink p-6 text-white shadow-panel">
      ...
      <pre className="overflow-x-auto rounded-[1.5rem] bg-white/10 p-4 text-sm leading-7 text-mist">
